 ...
 */
public class MyReceiveCommentAdapter extends BaseQuickAdapter<MyReceiveComment, BaseViewHolder>{

    public MyReceiveCommentAdapter(@Nullable List<MyReceiveComment> data) {
