...
public class BackpackCertificationActivity2 extends BaseMvpActivity {
    ...
    private void initView() {
        ...
        tvCertification2.setEnabled(true);
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.f_btn_positive:
                if (ContextCompat.checkSelfPermission(BackpackCertificationActivity2.this, Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED
                        || ContextCompat.checkSelfPermission(BackpackCertificationActivity2.this, Manifest.permission.READ_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
                    //未获得权限
                    initPermissions();
                } else {
            ...
            case R.id.f_btn_reverse:
                ...
                break;
            case R.id.btn_next:
                ActivityLauncher.viewBackpackCertificationActivity3(this);
                break;
        }
    }
            ...
            switch (requestCode) {
                ...
                case ImageSelectorActivity.REQUEST_IMAGE:
                    ...
                    if (CAMERA.equals(POSITIVE_TYPE)) {
                        Glide.with(BackpackCertificationActivity2.this).load(images.get(0)).crossFade().into(ivPositive);
                        llPositive.setVisibility(View.GONE);
                    } else {
                        Glide.with(BackpackCertificationActivity2.this).load(images.get(0)).crossFade().into(ivReverse);
