package com.smyy.sharetour.buyer.live.roomutil.commondef;
...
import com.smyy.sharetour.buyer.live.roomutil.http.HttpRequests;
import com.smyy.sharetour.buyer.live.roomutil.http.HttpResponse;
import com.smyy.sharetour.buyer.live.roomutil.im.IMMessageMgr;
...
public abstract class BaseRoom implements IMMessageMgr.IMMessageListener {
    ...
    protected class HeartBeatThread extends HandlerThread {
        ...
        private Runnable heartBeatRunnable = new Runnable() {
            @Override
            public void run() {
                boolean success = mHttpRequest.heartBeat(userID, roomID);
                if (success){
