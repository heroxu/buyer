...
package com.smyy.sharetour.buyer.view.pickerview.wheel;
...
import com.smyy.sharetour.buyer.view.pickerview.adapters.WheelViewAdapter;
import com.smyy.sharetour.buyer.view.pickerview.config.DefaultConfig;
...
public class WheelView extends View {
    ...
    private Paint mPaintLineCenter, mPaintLineRight, mPaintRectCenter, mPaintBackground;
    ...
    private void initData(Context context) {
        ...
        mPaintBackground.setColor(DefaultConfig.BACKGROUND_COLOR);
        mPaintBackground.setAlpha((int) (1.0 * 255));
...
//        mPaintLineRight.setStrokeWidth(context.getResources().getDimensionPixelSize(R.dimen.picker_line_width));
    ...
    public void setConfig(PickerConfig config) {
        ...
        mPaintBackground.setColor(getResources().getColor(config.mBackgroundColor));
        mPaintBackground.setAlpha((int) (1.0 * 255));
