...
public class KeyboardUtil {
    ...
    public KeyboardUtil(View view, boolean ifRandom) {
        this.mView = view;
        this.mIfRandom = ifRandom;
        mKeyboardNumber = new Keyboard(view.getContext(), R.xml.keyboardnumber);
        mKeyboardView = (MyKeyBoardView) mView.findViewById(R.id.keyboard_view);
    }
    ...
    public void attachTo(EditText editText) {
        ...
        hideSystemSofeKeyboard(mView.getContext().getApplicationContext(), mEditText);
        showSoftKeyboard();
    }

    public void showSoftKeyboard() {
        if (mKeyboardNumber == null) {
            mKeyboardNumber = new Keyboard(mView.getContext(), R.xml.keyboardnumber);
        }
